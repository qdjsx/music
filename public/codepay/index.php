    ...
    <section class="clearfix g-member">
        ...
        <form action="codepay.php" method="post">
            <article class="clearfix mt10 m-round g-pay-ment g-bank-ct">
                <ul id="ulBankList">
                    <li class="gray6" style="width: 100%;padding: 5px 0px 0px 10px;height: 50px;">您需：<label
                            class="input" style="border: 1px solid #EAEAEA;height: 35px;font-size:30px;">
                            <input type="text" name="price" id="price" placeholder="如：50" value="0.01"
                                   style="width: 170px;color: red;font-size:20px;" readonly="">   <!--默认输入金额值50-->
                        </label> 元购买
                    </li>
                    <li class="gray6"
                        ...
                        充值用户名：<label
                            ...
                            <input type="text" name="user" id="user" placeholder="用户名" value="<?php echo $user ?>"
                                   style="width: 180px;font-size: 16px;" readonly="">
                        </label></li>
